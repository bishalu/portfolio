...
const BentoCard = ({
  ...
  return (
    ...
    >
      <div>
        {background || (backgroundClass && <div className={cn('absolute inset-0 opacity-20', backgroundClass)} />)}
      </div>
      ...
      >
        <ShinyButton href={href} className="pointer-events-auto px-4 py-1 text-sm">
          {cta} <ArrowRightIcon className="ml-2 inline h-4 w-4" />
        </ShinyButton>
      </div>

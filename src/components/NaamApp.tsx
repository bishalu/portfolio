      ...
      <div className="nm-streamwrap">
        ...
        {!asked && opening.done && (
          ...
          >
            ...
            {/* THE INK HAS WIDTH NOW, AND IT VARIES.
                A pen does not lay down a constant 2.2px, and the uniform stroke
                is what made this read as a vector illustration of a doodle
                rather than as one. SVG cannot vary stroke-width along a path,
                so the ink is a FILLED OUTLINE: the centreline offset to either
                side by a width that follows the curve's own curvature.

                Curvature is the right driver because it is where the hand
                actually slows — the two loops are corners the wrist has to work
                around, and ink pools where the pen dwells. It runs 1.45px on
                the fast straights and 3.3px in the tightest part of a loop.

                Only the START tapers. Tapering both ends is the reflex and it
                was wrong: this stroke does not lift at the end, it STOPS so two
                barbs can be added to it, and thinning it to nothing there left
                the arrowhead hanging off a hairline.

                The draw-on still has to work, so the reveal moved to a mask: the
                original centreline, stroked wide in white, swept by the same
                dashoffset animation as before. The outline is static; the mask
                is what animates. */}
            <defs>
            ...
            <path className="nm-doodle-line" d="M44.9 12.4L46.0 12.9L47.5 13.6L49.2 14.4L50.8 15.0L52.4 15.4L53.8 15.8L55.1 16.1L56.4 16.3L57.7 16.4L59.0 16.4L60.1 16.3L61.1 16.2L62.1 16.0L63.1 15.8L64.0 15.5L64.8 15.3L65.5 15.0L66.3 14.7L67.0 14.2L67.6 13.6L68.0 12.9L68.1 12.1L68.1 11.3L68.0 10.6L67.7 9.9L67.1 9.3L66.5 8.7L65.8 8.3L65.1 7.9L64.3 7.5L63.4 7.1L62.5 6.8L61.3 6.6L60.2 6.4L58.9 6.3L57.6 6.2L56.3 6.1L54.7 6.2L53.2 6.4L51.6 6.6L49.9 7.0L48.2 7.4L46.5 7.9L44.7 8.6L42.9 9.3L41.1 10.2L39.3 11.1L37.6 12.2L35.9 13.4L34.2 14.8L32.5 16.2L30.9 17.8L29.5 19.4L28.1 21.1L26.8 22.9L25.6 24.7L24.5 26.7L23.6 28.7L22.7 30.8L22.0 32.9L21.5 35.0L21.1 37.2L20.8 39.4L20.6 41.6L20.6 43.7L20.7 45.9L21.0 48.1L21.3 50.2L21.8 52.2L22.5 54.3L23.2 56.3L24.0 58.2L24.9 60.1L25.9 61.9L26.9 63.6L28.1 65.3L29.3 66.9L30.5 68.4L31.8 69.9L33.2 71.3L34.5 72.5L36.0 73.7L37.4 74.9L38.8 75.9L40.2 77.0L41.7 77.9L43.2 78.8L44.6 79.5L46.1 80.2L47.5 80.9L48.9 81.5L50.4 82.0L51.8 82.3L53.1 82.7L54.4 82.9L55.7 83.2L56.9 83.4L58.0 83.4L59.2 83.4L60.2 83.4L61.2 83.3L62.1 83.2L63.0 83.0L63.7 82.9L64.5 82.7L65.2 82.3L66.0 81.9L66.4 81.3L66.7 80.7L66.9 79.8L66.8 78.9L66.4 78.2L65.9 77.5L65.3 77.1L64.5 76.8L63.7 76.6L62.9 76.4L62.0 76.3L61.0 